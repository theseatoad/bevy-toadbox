...
/// Inspiration from https://github.com/bevyengine/bevy/blob/main/examples/games/game_menu.rs.
pub struct MainMenuPlugin;

#[derive(AssetCollection, Resource)]
pub struct MainMenuAssets {
    #[asset(path = "main/menu-font.ttf")]
    pub main_menu_font: Handle<Font>,
    #[asset(path = "main/menu-background.png")]
    pub main_menu_background: Handle<Image>,
    #[asset(path = "main/menu-music.ogg")]
...
impl Default for MainMenuSettings {
    fn default() -> Self {
        Self {}
    }
}
...
impl Plugin for MainMenuPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.init_resource::<MainMenuSettings>()
            ...
            .add_system_set(
                SystemSet::on_exit(GameState::Boot).with_system(despawn_screen::<OnMainMenuScreen>),
            );
    }
}
...
fn setup(
    mut commands: Commands,
    settings: Res<MainMenuSettings>,
    assets: Res<MainMenuAssets>,
    audio: Res<Audio>,
) {
    let font = assets.main_menu_font.clone();
    let music = assets.main_menu_music.clone();
    audio.play(music);
}
